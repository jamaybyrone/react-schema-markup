...
import {RichEventProps, RichEventType} from "../src/types/event";
...
const testCases: TestCases = [
    {
        ...
        props: {
            eventData: {
                ...
                description: "An absurdly British event featuring all things quintessentially British: endless tea, queueing competitions, and a mandatory umbrella parade.",
                performer: {
    ...
    },
    {
        ...
        props: {
            eventData: {
                ...
                description: "An in-depth lecture on why the British are so uniquely talented at complaining about the weather. Tea and biscuits provided.",
                organizer: {
